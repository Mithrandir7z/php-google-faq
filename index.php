<?php 
    $domande = [
        [   
            'domanda' => "clausole google",

            'risposta' => "La Commissione europea ha approvato l'utilizzo di clausole 
        ...
        [   
            'domanda' => "Disposizioni dell'EU-U.S. Privacy Shield",

            'risposta' => "Come descritto nella nostra certificazione Privacy 
...
<body>
    ...
    <main>
        ...
        <div class="testo"> 
            ...
            <?php foreach($domande as $key => $arrayElement) { ?> 

                <h3> <?php echo $arrayElement['domanda']; ?> </h3>

                <p>
                    <?php echo $arrayElement['risposta']; ?>
                </p>
